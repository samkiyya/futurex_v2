    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(
          bottom: 16.0,
          right: 16.0,
        ), // Adjust position above the navigation bar
        child: FloatingActionButton(
          ...
          child: Image.asset(
            'assets/images/bot.png', // Path to your bot.png image
      ...
      body: Column(
        ...
        children: [
            ...
            child: GestureDetector(
              onDoubleTapDown: (details) {
                ...
                if (tapX < screenWidth / 2) {
                  _jumpSeconds(-15); // Rewind 15 seconds
                } else {
                  _jumpSeconds(15); // Fast forward 15 seconds
                }
              },
              onLongPressStart: (details) {
                ...
                final screenWidth = screenSize.width;
                if (tapX < screenWidth / 2) {
                  _startContinuousJump(-5); // Continuous rewind
                } else {
                  _startContinuousJump(5); // Continuous fast-forward
                }
              },
          ...
          if (_isOverlayVisible)
            Center(
              child: Container(
                ...
                child: Text(
                  _overlayText, // Handle null overlay text
                  style: TextStyle(
          ...
          Expanded(
            child: Column(
              children: [
                // Display the current lesson below the video
                _currentlyPlayingIndex != -1
                    ? Padding(
                        padding: const EdgeInsets.all(16.0),
                        child: Text(
                          " ${widget.lessons[_currentlyPlayingIndex]['lesson'] ?? 'No Lesson'}", // Safe null handling
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: themeProvider.isDarkMode
                    ...
                    : Padding(
                        ...
                        child: Text(
                          widget.title, // Safe null handling
                          style: TextStyle(
                            fontSize: 18,
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      LessonCheckerService.getLessonType(
                        video['lesson_type'] ?? '', // Null-aware handling
                        video['video_type'] ?? '', // Null-aware handling
                        video['link'] ?? '',
                        video['attachment_type'], // Null-aware handling
                      );
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      video["title"] ??
                                          'Untitled Lesson', // Safe null handling
                                      style: TextStyle(
                                        fontSize: 16,
                                        ...
                                        color: _currentlyPlayingIndex == index
                                            ...
                                            ? Colors.white
                                            : Colors
                                                  .blue, // Change color if currently playing
                                      ),
